...
namespace IcarusRDP_builder
{
    internal class Obfuscate
    {
        ...
        private sealed class __c
        {
            ...
            public static Func<string, char> __9__0_0;

            internal char _random_string_b__0_0(string s)
            {
        ...
        public static string random_string(int length)
        {
            ...
            do
            {
                text = new string(Enumerable.Repeat("αβγδεζηθικλμνξοπρστυφχψωΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzابتثجحخدذرزسشصضطظعغفقكلمنهويابتثجحخدذرزسشصضطظعغفقكلمنهوي艾诶比西迪伊弗吉尺杰开勒马娜哦屁吉吾儿丝提伊吾维豆贝尔维克斯吾贼德אבגדהוזחטיכךלמםנןסעפףצץקרשתאבגדהוזחטיכךלמםנןסעפףצץקרשת0123456789", length).Select(__c.__9__0_0 ?? (__c.__9__0_0 = __c.__9._random_string_b__0_0)).ToArray());
            }
